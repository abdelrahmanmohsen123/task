        ...
        return this.each(function() {
            function t(t) {
                a = e("<div/>", {
                    ...
                    "class": "icon-popup"
                }), a.html('<div class="ip-control"> <ul><li><a href="javascript:;" class="btn" data-dir="-1"><i class="icofont-arrow-left"></i></a></li> 						            <li><input type="text" class="ip-search icofont-ui-search" placeholder="Search" /></li> 						            <li><a href="javascript:;"  class="btn" data-dir="1"><i class="icofont-arrow-right"></i></a></li> 						          </ul> 						      </div> 						     <div class="icon-list"> </div> 					         ').appendTo("body"), a.addClass("dropdown-menu").show(), a.mouseenter(function() {
                    o = !0
                }).mouseleave(function() {
                    o = !1
                });
            ...
            function l(t, o) {
                $ul = e("<ul>");
                for (var i in o) $ul.append('<li><a href="#" title=' + o[i] + '><i class="icofont-' + o[i] + '"></i></a></li>');
            ...
            element = this, n.buttonOnly || void 0 != e(this).data("iconPicker") || ($this = e(this).addClass("form-control"), $wraper = e("<div/>", {
                "class": "input-group"
            }), $this.wrap($wraper), $button = e('<i class="input-group-addon pointer pickericon"><i class="icofont-arrow-down"></i></i>'), $this.after($button), function(e) {
